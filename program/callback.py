...
🤖 **[H𝗢𝗦𝗦𝗔𝗠 𝑀𝑈𝑆𝐼𝐶࿃🎶](https://t.me/sasa_boody) **
...
async def cbguides(_, query: CallbackQuery):
 ...
 ⌯ إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا من هنا ↤ @mostafa_3w

⌯ قناه سورس كلير ميوزك 🎵  @sasa_boody
__""",
        reply_markup=InlineKeyboardMarkup(
...
⌯ قناة سورس كلير ميوزك 🎵 @sasa_boody  """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
✦┅━╍━╍╍━━╍━━╍━┅✦
⌯ ⌯ قناة سورس كلير ميوزك 🎵  @sasa_boody__""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙رجوع", callback_data="cbcmds")]]
        ),
    )
