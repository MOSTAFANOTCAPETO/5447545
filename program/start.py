        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                  ...
                  "klaer music",
                        url=f"https://t.me/sasa_boody"),
                ],
                [
                    InlineKeyboardButton("M U S T A F A", url=f"https://t.me/mostafa_3w"),
                ],
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
            [
               [
                ...
                [       
                    InlineKeyboardButton(
                      "klaer music", url=f"https://t.me/sasa_boody"
                    ),
                ],
                [
                    InlineKeyboardButton("• اضافه البوت اللي مجموعتك •", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
    ...
    alive = f"**• اهلا بك يا  {message.from_user.mention()}   \n •افضل سورس علي تيليجرام \n • ايدك لاقطعالك دا مش للعب ** "
...
@Client.on_message(command(["مطور", "المطور"]) & filters.group & ~filters.edited)
async def help(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://t.me/c/1573528261/3",
      caption=f"""• DEV  M U S T A F A @mostafa_3w 🎵""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("M U S T A F A", url=f"https://t.me/mostafa_3w"),
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/130807f4863c6cd3b2bce.jpg",
