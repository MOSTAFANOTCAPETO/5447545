...
@Client.on_message(command(["mplay","شغل","تشغيل","play", f"mplay@{BOT_USERNAME}"]) & other_filters)
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("klaer music", url=f"https://t.me/sasa_boody"),
                ],
...
@Client.on_message(command(["stream","play","شغيل","شغل","تشغيل" f"stream@{BOT_USERNAME}"]) & other_filters)
